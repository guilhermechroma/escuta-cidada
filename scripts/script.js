// TODO: Adicionar funções ao App.tsx
  ...
  document
    ...
    .addEventListener("submit", async function (e) {
      ...
      const data = {
        ...
        avtransport:
          document.querySelector('input[name="avtrasnport"]:checked')?.value ||
          null,

        // Pega o valor do input do tipo radio que estiver selecionado no grupo 'avsite', ou null se nenhum selecionado
        avsite:
          document.querySelector('input[name="avsite"]:checked')?.value || null,
      };
